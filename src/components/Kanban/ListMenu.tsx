...
export function ListMenu(props: IListMenuProps) {
  ...
  return (
    <Menu as="div" className="relative">
      ...
      >
        <Menu.Items className="absolute right-0 z-20 mt-2 w-32 origin-top-right rounded-md bg-[#ffffff] shadow-lg ring-1 focus:outline-none focus:ring-indigo-600 dark:bg-slate-900">
          <div className="p-1">
            <Menu.Item>
              {({ active }) => (
                <button
